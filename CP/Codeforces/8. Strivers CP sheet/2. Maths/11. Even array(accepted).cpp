...
void solve()
{
    ...
    int unmatchedOddParity = 0;
    int unmatchedEvenParity = 0;
    for(int i=0; i<n; i++)
    {
        if(givenArray[i]%2 != i%2)
        {
            if(givenArray[i]%2==0)
            {
                unmatchedEvenParity++;
    ...
    if(unmatchedEvenParity==unmatchedOddParity)
    {
        cout << unmatchedEvenParity << endl;
    }
    else
    {
        cout << "-1" << endl;
